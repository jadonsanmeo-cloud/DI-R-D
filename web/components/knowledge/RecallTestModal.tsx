    ...
    >
      <Card
        ...
        extra={
          <Popover
            ...
            trigger='hover'
            title={t('kn.vectorRetrievalSettings')}
            content={
              <Form
                form={extraForm}
                initialValues={{
              ...
              >
                <Form.Item label='Topk' tooltip={t('kn.topkTooltip')} name='recall_top_k'>
                  <InputNumber placeholder={t('kn.pleaseInput')} className='w-full' />
                </Form.Item>
                <Form.Item label={t('kn.recallMethod')} name='recall_retrievers'>
                  <Select
                    mode='multiple'
                ...
                <Form.Item label={t('kn.scoreThreshold')} name='recall_score_threshold'>
                  <InputNumber placeholder={t('kn.pleaseInput')} className='w-full' step={0.1} />
                </Form.Item>
              </Form>
            }
          >
      ...
      >
        <Form form={form} layout='vertical' onFinish={onTest}>
          <Form.Item
            label={t('kn.testQuestion')}
            required={true}
            name='question'
            rules={[{ required: true, message: t('kn.pleaseInputTestQuestion') }]}
            className='m-0 p-0'
          >
            <div className='flex w-full items-center gap-8'>
              <Input placeholder={t('kn.pleaseInputTestQuestion')} autoComplete='off' allowClear className='w-1/2' />
          ...
          {/* {questions?.length > 0 && (
              <Col span={16}>
                <Form.Item label={t('kn.recommendedQuestions')} tooltip={t('kn.clickToSelectAutoFill')}>
      ...
      <Card title={t('kn.recallResult')} size='small'>
