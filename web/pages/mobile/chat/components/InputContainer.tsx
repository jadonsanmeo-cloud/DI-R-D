    ...
    <div className='flex flex-col'>
      ...
      <div className='flex items-center justify-between gap-1'>
        ...
        <div className='flex items-center justify-between text-lg font-bold'>
          <Popover content={t('mob.pauseReply')} trigger={['hover']}>
            <PauseCircleOutlined
          ...
          <Popover content={t('mob.tryAgain')} trigger={['hover']}>
            <RedoOutlined
              className={classnames('p-2 cursor-pointer', {
          ...
          {loading ? (
            ...
            <Popover content={t('mob.clearHistory')} trigger={['hover']}>
              <ClearOutlined
                className={classnames('p-2 cursor-pointer', {
                  'text-gray-400': !history.length || !canNewChat,
                })}
      ...
      >
        <Input.TextArea
          placeholder={t('mob.askMeAnything')}
