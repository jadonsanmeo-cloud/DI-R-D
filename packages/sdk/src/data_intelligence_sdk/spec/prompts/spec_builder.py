...
intent_analysis, corpus_summary, session_brief, and user_brief. When
intent_analysis.processing_steps is present, use those governed steps as planning
guidance for the objective, capability requirements, and constraints. Apply only
steps relevant to the available data and request scope; do not treat capability
names as already resolved tools. Use spec_context.corpus_summary as the primary
readable map of the available data.
