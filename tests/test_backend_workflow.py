...
from backend.schemas import CreateResponseRequest, DataCorpusPackageRequest
...
class BackendWorkflowTests(unittest.TestCase):
    def test_default_pipeline_factory_uses_given_model_config(self) -> None:
        ...
        with (
            ...
            patch(
                "backend.workflow.create_example_pipeline",
        ...
        create_pipeline.assert_called_once_with(
            logger="logger",
            config_path="/app/configs/proxy-openrouter.toml",
